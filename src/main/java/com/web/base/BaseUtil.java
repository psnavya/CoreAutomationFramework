...
import com.helper.testDataHandling.DataHelper;
...
import com.execution.MasterXMLSuite;
import com.helper.driver.InstanceValidation;
...
import com.utilities.WaitClass;
...
import static com.helper.testDataHandling.DataHelper.readTestDataSet;
...
public class BaseUtil {
   ...
   /*
Appium Related
public static MobileActionsClass MobileActions = new MobileActionsClass();
*/
    ...
    /*
    Appium Related// public static AppiumDriver driverInstanceMobile(){
    ...
    public static void setVerificationElement(WebElement verificationElement) {
        BaseUtil.verificationElement = verificationElement;
    }
...
/*Appium Related
    ...
    public static void setCurrentExcelPath(String currentExcelPath) {
        BaseUtil.currentExcelPath = currentExcelPath;
    }
